...
aggr_df = aggr_df.query('ZONEID==1')
...
#%%
    ...
    #    temp_pred = probabilistic_models[model].predict(testX_weather)
    #    print(f'{model}: {eval_point_pred(temp_pred, testY.values)}')
